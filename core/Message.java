...
//	 * 	will be the same for all replicates of the message)
//	 * @param size Size of the message (in bytes)
//         * @param contentInterest interest of Node 
//	 */
//        public Message(DTNHost from, DTNHost to, String id, int size, String contentInterest) {
//		this.from = from;
//		this.to = to;
//		this.id = id;
//		this.size = size;
...
//		this.uniqueId = nextUniqueId;
//		
//                this.contentInterest = contentInterest;
//                
//		this.timeCreated = SimClock.getTime();
//		this.timeReceived = this.timeCreated;
//		this.initTtl = INFINITE_TTL;
...
//	
	...
	protected void copyFrom(Message m) {
		...
		this.appID = m.appID;
                //this.contentInterest = m.contentInterest;
...
//        public String getContentInterestM(){
