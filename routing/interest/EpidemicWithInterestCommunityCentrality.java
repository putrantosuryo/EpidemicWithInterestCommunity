 ...
 */
public class EpidemicWithInterestCommunityCentrality implements routing.RoutingDecisionEngine, CommunityDetectionEngine {
    ...
    public EpidemicWithInterestCommunityCentrality(Settings s) {
    ...
    public EpidemicWithInterestCommunityCentrality(EpidemicWithInterestCommunityCentrality proto) {
    ...
    public void doExchangeForNewConnection(Connection con, DTNHost peer) {
        ...
        EpidemicWithInterestCommunityCentrality Epic = this.getOtherDecisionEngine(peer);
    ...
    public boolean shouldSendMessageToHost(Message m, DTNHost otherHost) {
        ...
        EpidemicWithInterestCommunityCentrality epic = getOtherDecisionEngine(otherHost);
        /*
         */
    ...
    public boolean shouldDeleteSentMessage(Message m, DTNHost otherHost) {
        ...
        EpidemicWithInterestCommunityCentrality de = this.getOtherDecisionEngine(otherHost);
    ...
    public boolean shouldDeleteOldMessage(Message m, DTNHost hostReportingOld ) {
        EpidemicWithInterestCommunityCentrality de = this.getOtherDecisionEngine(hostReportingOld);
        return de.commumesWithHost(m.getTo())
                && !this.commumesWithHost(m.getTo());
    }
    ...
    public RoutingDecisionEngine replicate() {
        return new EpidemicWithInterestCommunityCentrality(this);
    }

    private EpidemicWithInterestCommunityCentrality getOtherDecisionEngine(DTNHost h) {
        MessageRouter otherRouter = h.getRouter();
        assert otherRouter instanceof DecisionEngineRouter : "This router only works "
                + " with other routers of same type";

        return (EpidemicWithInterestCommunityCentrality) ((DecisionEngineRouter) otherRouter).getDecisionEngine();
    }
}
